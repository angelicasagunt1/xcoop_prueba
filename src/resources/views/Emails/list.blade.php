...
<body>
<h1>Listado de Codigos de ticket de acuerdo a email </h1>
...
<table class="table table-bordered table-striped table-condensed">
    ...
    @empty
        <tr>
            <td colspan="100%" style="text-align: center;">
                No se han encontrado codigos relacionados a el email ingresado, intenta con otros :(
            </td>
        </tr>
    @endforelse
    </tbody>
    ...
    <h3> Puedes intentar enviar por parametro los siguientes mails </h3>
